[
// Either load the file countdown.lasso during server or site startup,
// in server or site library, or include it.  Choose one method.
// I recommend site startup.
// include('countdown.lasso'); // optional loading method
]<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    <title>countdown by Steve Piercy</title>
    <link rel="stylesheet" type="text/css" media="screen" href="jquery.datetimeentry.css" />
</head>
<body>
<h1>countdown by Steve Piercy</h1>
<form action="[response_filepath]" method="post">
<div>
<label>T-0 (Count down to this time)</label>
...
$(function () {
    ...
    $('#timezone').datetimeEntry({datetimeFormat: 'Y-O-D H:M:S'});
});
</script>
</body>
</html>
